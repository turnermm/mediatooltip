...
$lang['enable_userid'] = 'If set to true (default) and no user group is found it will be used to create the image id.';
...
$lang['date_style'] = 'This option will set the date-time style.  Dates are numeric, e.g.  2018-11-09.  A time can be appended to ' .
